...
import { hr, emp, lead, owner, manager } from "../views/routes.js";
  ...
  if (role === "employee") {
    ...
    const getBrandText = (path) => {
      for (let i = 0; i < emp.length; i++) {
        if (
          props.location.pathname.indexOf(emp[i].layout + emp[i].path) !== -1
        ) {
          return emp[i].name;
        }
      }
  ...
  if (role === "lead") {
    ...
    const getBrandText = (path) => {
      for (let i = 0; i < lead.length; i++) {
        if (
          props.location.pathname.indexOf(lead[i].layout + lead[i].path) !== -1
        ) {
          return lead[i].name;
        }
      }
  ...
  if (role === "hr") {
    ...
    const getBrandText = (path) => {
      for (let i = 0; i < hr.length; i++) {
        if (props.location.pathname.indexOf(hr[i].layout + hr[i].path) !== -1) {
          return hr[i].name;
        }
      }
      return "Brand";
      ...
      for (let i = 0; i < manager.length; i++) {
        if (
          props.location.pathname.indexOf(
            manager[i].layout + manager[i].path
          ) !== -1
        ) {
